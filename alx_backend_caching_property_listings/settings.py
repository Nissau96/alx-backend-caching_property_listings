...
SECRET_KEY = 'django-insecure-0328(jfx0jg3ckhmkhv^fdpgny&20n)_hq=x%l25g#y7i^qvbf'
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='property_user'),
        'PASSWORD': config('DB_PASSWORD', default='property_password123'),
